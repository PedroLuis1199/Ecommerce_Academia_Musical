          ...
          {carrito.length === 0 ? 'Carrito vacio' :(
            ...
            carrito.map(producto =>(
              ...
              <div key={producto.id} className = {styles.producto}>
                    ...
                    <div>
                      <Image layout = 'responsive' width={250} height = {400} src = {producto.imagen} />
                    </div>
                ...
                <button type='button' className={styles.eliminar} title='Eliminar producto del carrito' onClick={()=>eliminarProducto(producto.id)}>X</button>
